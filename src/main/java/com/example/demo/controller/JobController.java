...
public class JobController {
    ...
    public void addjob(@RequestParam(value = "jobClassName") String jobClassName,
        ...
        addSchJob(jobClassName, jobGroupName, cronExpression);
    }

    public void addSchJob(String jobClassName, String jobGroupName,
    ...
    public void jobreschedule(String jobClassName, String jobGroupName,
                              String cronExpression) throws Exception {
        try {
